...
import Versioncontrol from '@opentiny/tiny-engine-plugin-version-control'
...
const addons = {
  plugins: [Materials, Tree, Page, Block, Datasource, Bridge, I18n, Script, Data, Schema, Help, Robot, Versioncontrol],
  toolbars: [
    Logo,
    Breadcrumb,
    Media,
